    ...
    \end{align*}
        ...
        \begin{figure}[htbp]
          ...
          \begin{enumerate}
              ...
              \begin{enumerate}
                  \item 一点连续:
                  If $\lim\limits_{x \to a}f(x)=f(a)$ 或$f(a-0)=f(a+0)=f(a)$，则称$f(x)$在$x = a$连续。
                  \item $f(x)$在$[a,b]$上连续：If $f(x)$在$(a,b)$内连续，且$f(a)=f(a+0),f(b)=f(b-0)$。则称$f(x)$在$[a,b]$上连续，记为$f(x)\in C[a,b]$。
              \end{enumerate}
              \item 间断:If $\lim\limits_{x \to a}f(x)\neq f(a)$
              分类：
              \begin{enumerate}
